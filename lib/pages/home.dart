...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    // Reauthenticate user when app is opned
  ...
  configurePushNotification() {
    ...
    _firebaseMessaging.getToken().then((token) {
      print('Firebase Messaging Token: $token¥n');
      usersRef
          .document(user.id)
  ...
  void createUserInFirestore() async {
    ...
    if (!doc.exists) {
      ...
      // 3) get username from from create account, user it to make new user document in users collection.
  ...
  login() async {
    ...
    firebaseCurrentUser = await _auth.currentUser();
  }
