...
exports.onCreateFollower = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    console.log('Follower Creaeted', snapshot.id)
    ...
    // 4) Add each user posts to following user's timeline
...
exports.onCreateActivityFeedItem = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    ...
    // 2) Once we have user, check if they have a notification toke; send notification, if they have token
    ...
    function sendNotification(androidNotificationToken, activityFeedItem) {
      ...
      switch (activityFeedItem.type) {
        case 'comment':
          ...
          break
        case 'like':
          body = `${activityFeedItem.uasername} liked your post`
          break
        case 'follow':
